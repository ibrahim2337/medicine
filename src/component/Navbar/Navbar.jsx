              ...
              <Link>
                <div className="flex flex-col">
                  <h1 className="text-3xl font-bold">
                    Smile<b className="text-red-900">Z</b>
                  </h1>
                  <h3 className="uppercase text-sm">
                    keep it fresh,keep it young
                  </h3>
                </div>
              </Link>
            </div>
              ...
              <div className="w-full sm:max-w-xs">
                ...
                <div className="relative">
                  ...
                  <input
                    id="search"
                    name="search"
                    className="block w-full rounded-md border py-1.5 pl-10 pr- focus:bg-white focus:text-gray-500 focus:ring-0 focus:placeholder:text-gray-500 sm:text-sm sm:leading-6"
                    placeholder="Search"
                    type="search"
                  />
                </div>
