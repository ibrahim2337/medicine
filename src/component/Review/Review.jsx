...
import ratingIcon from "../../assets/rating/rating (1).png";
    ...
    return (
        ...
        <Marquee>
          <div className="flex flex-row gap-5">
            <div className="w-72">
              <div className="px-4 py-7 rounded-t-lg  bg-[#e9edf0] sm:px-8 md:px-10">
                <p className="relative left-0 pt-5 px-5 bg-white rounded-md text-lg text-center">
                  ...
                  <svg
                    ...
                    viewBox="0 0 512 512"
                    fill="currentColor"
                    className="absolute right-5 top-5 w-8 h-6  "
                  >
              ...
              <div className="flex flex-row gap-4 items-center justify-center py-4 rounded-b-lg bg-[#D3D7DA] text-white">
                <img
                ...
                <div className=" flex flex-col items-center">
                  <p className="text-lg font-semibold text-black">Ibrahim Khalilullah</p>
